...
export class HeadLockBehaviorInput extends BaseScriptComponent {
  ...
  @input("float", "0.0")
  @hint(
    "The magnitude of change in degrees of leeway in any direction before a change starts to occur"
  )
  readonly bufferRotationDegrees: number

  @input("float", "0.0")
  @hint(
    "The magnitude of change needed to activate a translation for the target to follow the camera (centimeters)"
  )
