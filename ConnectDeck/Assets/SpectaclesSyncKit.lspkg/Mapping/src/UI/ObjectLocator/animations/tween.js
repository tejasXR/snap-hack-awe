(function (global, factory) {
  ...
  var Tween = /** @class */ (function () {
    ...
    Tween.prototype._setupProperties = function (
      ...
      for (var property in _valuesEnd) {
        ...
        if (
          ...
          if (!this._isDynamic) {
            var tmp = {};
            for (var propName in endValues) tmp[propName] = endValues[propName];
    ...
    Tween.prototype.update = function (time, autoStart) {
      ...
      var elapsed = this._calculateElapsedPortion(
        elapsedTime,
        durationAndDelay,
        totalTime,
      );
      var value = this._easingFunction(elapsed);
      var status = this._calculateCompletionStatus(elapsedTime);
      if (status === "repeat") {
    ...
    Tween.prototype._calculateElapsedPortion = function (
      elapsedTime,
      durationAndDelay,
      totalTime,
    ) {
      ...
      if (
        portion === 0 &&
        elapsedTime !== 0 &&
        elapsedTime % this._duration === 0
      ) {
        return 1;
      }
      return portion;
    };
    Tween.prototype._calculateCompletionStatus = function (elapsedTime) {
    ...
    Tween.prototype._processRepetition = function (
      elapsedTime,
      durationAndDelay,
    ) {
      ...
      for (var property in this._valuesStartRepeat) {
        ...
        if (!this._yoyo && typeof valueEnd === "string") {
          this._valuesStartRepeat[property] =
            this._valuesStartRepeat[property] + parseFloat(valueEnd);
        }
        if (this._yoyo) {
          this._swapEndStartRepeatValues(property);
        }
